...
export default function AboutPage() {
  return (
    <div className="min-h-screen font-sans bg-white">
      ...
      <section className="bg-white text-gray-800 py-6 sm:py-8 px-4">
